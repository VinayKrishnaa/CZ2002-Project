...
public class PaymentController {
	...
	public PaymentController(ReservationController rescon, RoomController roomcon) {//NOT COMPLETE
		...
		currentBills = new Bill[48?] //confirm how many rooms we want
				
		//once confirm details like total room number, can actually create the bills for each room here and initialize the ROOMID
		for(i=0; i<48; i++) { //confirm whether 48 rooms or how many?!
			currentBills[i] = new Bill();
			currentBills[i].setRoomID(i+1); // this way of seting ID is just 1-48.. modify if ID naming more complex
		}
	}
